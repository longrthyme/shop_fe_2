...
import {getOrderById, updateStatusOrder, history,updateShipping} from '../api/OrderApi'; // Đảm bảo đúng đường dẫn import API
import {useParams} from 'react-router-dom';
import {getTinhThanh, getQuanHuyen, getPhuongXa, getShip} from '../api/DiaChiApi';
import {CheckOutlined, CloseOutlined, HistoryOutlined, PrinterOutlined} from "@ant-design/icons";
...
const AdminOrderDetail = () => {
    ...
    const handleConfirm = async (newStatus) => {
        try {
            ...
            await updateStatusOrder(id, newStatus);
                        ...
                        <div style={{marginBottom: "20px"}}>
                            ...
                            <Row gutter={[16, 16]}>
                                <Col span={12}>
                                    ...
                                    <Text type="secondary">{orderData?.status || "N/A"}</Text>
                                </Col>
                                <Col span={12}>
                        ...
                        <div style={{marginBottom: "20px"}}>
                                        ...
                                        <Button
                                            ...
                                            onClick={() => {
                                                ...
                                                setNewShippingAddress({
                                                    ...
                                                    idTinhThanh: shippingAddress.idTinhThanh || null,
                                                    idQuanHuyen: shippingAddress.idQuanHuyen || null,
                                                    idPhuongXa: shippingAddress.idPhuongXa || null,
                                                    ship: orderData?.shippingFee || null
                                                })
                                                setAutoSet(false);
                            ...
                            <Row gutter={[16, 16]} style={{marginTop: "10px"}}>
                                ...
                                <Col span={24}>
                                    <Text strong>Địa chỉ:</Text>{" "}
                                    <Text type="secondary">
                                        {orderData?.shippingAddress?.address + ', ' + cities[shippingAddress.idTinhThanh] + ", " + districts[shippingAddress.idQuanHuyen] + ", " + wards[shippingAddress.idPhuongXa] || "N/A"}
                                    </Text>
                                </Col>
                            </Row>
                        </div>
