        ...
        try {
            ...
            if (response.status < 300) {
                ...
                if (result.isSuccess == true) {
                    ...
                    var orderRequest = window.localStorage.getItem("orderDtoAdmin");
                    ...
                    if (orderRequest) {
                       ...
                       try {
                            ...
                            const response = await axios.post("http://localhost:8022/api/v1/sell/order", orderRequest, {
                                headers: {
                        ...
                        window.localStorage.removeItem("orderDtoAdmin"); // Xóa dữ liệu đơn hàng tạm
                    } else {
